...
import sty from "./PlasmicAddPost.module.css"; // plasmic-import: MhPR5BDCeWTk/css
  ...
  return (
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox__gRgge)}>
              {true ? (
                <div className={classNames(projectcss.all, sty.freeBox__nlydf)}>
                  {true ? (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__tJcoz)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
              ...
              >
                ...
                >
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__k63P)}
                  >
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__pRdqn)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                    ...
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__v8Oh)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                    ...
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__iluB)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
