...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: z1e2z9ksSf_/css
  ...
  return (
    ...
    >
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg___6ZRo)}
                role={"img"}
              />
            ),
      ...
      <input
        ...
        aria-labelledby={
          args["aria-labelledby"] !== undefined
        ...
        type={args.type !== undefined ? args.type : ("text" as const)}
        value={args.value !== undefined ? args.value : ("" as const)}
      />
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___8O9Nk)}
                role={"img"}
              />
            ),
